...
#+begin_src bash :exports both :results output replace :post shell_out(data=*this*)
...
#+begin_src bash :exports both :results output replace :post shell_out(data=*this*) :noeval
